...
public class RunArgal {
	...
	public static void mainArgal(String name_schema, String name_table, String name_table_101, int cid, String path, int year1, int year2) throws SQLException{
		 a.create_table(name_schema, name_table);
		 a.create_tabel_101(name_schema, name_table_101);
		 
		 for(int i = year1; i <= year2; i++){
			 a.load(name_schema, name_table, i, path);
		 }
//		 
