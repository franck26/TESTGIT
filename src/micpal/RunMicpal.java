...
public class RunMicpal {
	...
	public void mainMicpalOvdimPerMonths(String path_file, String name_schema, String tbl_101_sofi, int cid, int year1, int year2)
		...
		System.out.println("mainMicpalOvdimPerMonths");

		create_tables(name_schema, tbl_101_sofi, cid);

		for (int year = year1; year <= year2 ; year++) {
			m.load_data_micpal_kupot_gemel(path_file,name_schema,tbl_guemel,
					year);
	...
	private void create_tables(String name_schema, String tbl_101_sofi, int cid)
	...
	private void insertTo101(String name_schema, String tbl_101_sofi, int year1, int year2, int cid)
		...
		m.convert_to_101_kupot_gemel(name_schema, tbl_guemel_101, tbl_guemel,
				cid);
		m.Micpal_to_101_tashlumim(name_schema,cid, tbl_tashlumim_101,
				tbl_tashlumim);
