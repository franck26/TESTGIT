...
//		String sheilta = 
//				"CREATE TABLE  if not exists " + schema + "." + nameTable + "(\n"
//						+ "  `in_id` int(10) unsigned NOT NULL AUTO_INCREMENT,\n"
//						+ "  `num_worker` varchar(50) DEFAULT '0',\n"
//						+ "  `id` int(11) NOT NULL,\n"
//						+ "  `lastName` varchar(50) DEFAULT NULL,\n"
//						+ "  `firstName` varchar(50) DEFAULT NULL,\n"
//						+ "  `birthday` varchar(50) DEFAULT NULL,\n"
//						+ "  `atrala` varchar(50) DEFAULT NULL,\n";
//		
//		for (int i = 9; i<= 38; i++){
//			sheilta += "  `a" + i + "` varchar(50) DEFAULT NULL,\n";
//		}
//		
//						sheilta = "  `min` varchar(50) DEFAULT NULL,\n"
//						+ "  PRIMARY KEY (`in_id`),\n"
//						+ "  UNIQUE KEY `ind_unique` (`cid`,`id`) USING BTREE,\n"
//						+ "  KEY `indi3` (`cid`)\n"
...
//		truncate(schema, nameTable);
	...
	public void createTableExo(String name_schema, String name_hevra, String fieldsExo) throws SQLException {
		...
		s += array[array.length - 1] + " VARCHAR(200), KEY `ind` (`symbol`) ) DEFAULT CHARSET=utf8;";
...
//		System.out.println(s);
	...
	public void loadExo(String name_schema, String name_hevra, String pathFile, String fieldsExo) throws SQLException {
		System.out.println("load Exologia ");

		String s = "LOAD DATA  LOCAL INFILE '" + pathFile + "/exo/exo.csv' "
	...
	public void updateHagdaroth101(String name_schema, String name_hevra, String tbl_sofi) throws SQLException {
		...
		sheilta = "Update " + name_schema + "." + tbl_sofi + " as t1 "
				+ "inner join " + name_schema + "." + name_hevra + "_exo as t2 "
				+ "on t1.symbol = t2.symbol "
				+ "set t1.type_for_gemel = ';shulam_oved;pensya;sum_shulam;' , type = ';tlush_reshut;'   "
				+ "where t2.ofi in (50) ;";
		...
		sheilta = "update " + name_schema + "." + tbl_sofi + " set type = ';nikuy_chova;' where Symbol = '581'";

		sheiltoth.add(sheilta);

		sheilta = "update " + name_schema + "." + tbl_sofi + " set type = ';nikuy_chova;semelbb;' where Symbol = '584'";

		sheiltoth.add(sheilta);
		
		sheilta = "update " + name_schema + "." + tbl_sofi + " set type = ';nikuy_chova;semelbilo;' where Symbol = '582'";
