...
//                + "  (num_Worker, id_Worker, l_name, f_name, symbol,  symbolName, m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12) "
    ...
    void load_data_chelan_per_year_2(String name_schema, String name_file, String name_table, int year, int cid, String fields) throws SQLException {
...
//                + ", m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12"
                + ", num_worker) \n"
                + "   SELECT " + cid + " as cid,`dyear`,`mis_oved`as id,   concat(`f_name`,' ',`l_name`) as FullName,\n"
                + "    symbol as Symbol,symbolName as SymbolName , ifnull(m1,'0'),"
//                + ",ifnull(m2,'0'), ifnull(m3,'0'), ifnull(m4,'0'), ifnull(m5,'0'), "
